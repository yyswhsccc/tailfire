...
export default function RegionError({ error: _error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <p className="text-4xl">🗺️</p>
      <h2 className="mt-4 text-xl font-bold text-[#1A1A1A]">Something went wrong</h2>
      <p className="mt-2 text-sm text-[#888]">We couldn&apos;t load this region. Please try again.</p>
