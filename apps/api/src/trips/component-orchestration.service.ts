...
export class ComponentOrchestrationService {
  ...
  async getFlight(id: string): Promise<FlightComponentDto> {
    ...
    return {
      ...
      referralUrl: baseComponent.referralUrl || null,
      proposalStatus: baseComponent.proposalStatus,
      bookingStatus: baseComponent.bookingStatus,
  ...
  async createCustomCruise(dto: CreateCustomCruiseComponentDto): Promise<CustomCruiseComponentDto> {
    ...
    return {
      ...
      referralUrl: component.referralUrl || null,
      proposalStatus: component.proposalStatus || 'draft',
      bookingStatus: component.bookingStatus || 'unbooked',
