...
export const PROVIDER_METADATA: Record<ApiProvider, Omit<ProviderMetadataDto, 'isAvailable'>> = {
  ...
  [ApiProvider.AMADEUS_ACTIVITIES]: {
    provider: ApiProvider.AMADEUS_ACTIVITIES,
    displayName: 'Amadeus Activities',
    description: 'Amadeus Tours & Activities API for local experiences and sightseeing',
    documentation: 'Get credentials from: https://developers.amadeus.com → My Self-Service Workspace → Create App',
    sourcePolicy: 'env-only',
    envVars: {
      clientId: 'AMADEUS_CLIENT_ID',
  ...
  [ApiProvider.AMADEUS_HOTELS]: {
    provider: ApiProvider.AMADEUS_HOTELS,
    displayName: 'Amadeus Hotels',
    description: 'Amadeus Hotel Search API for accommodation booking',
    documentation: 'Get credentials from: https://developers.amadeus.com → My Self-Service Workspace → Create App',
    sourcePolicy: 'env-only',
    envVars: {
      clientId: 'AMADEUS_CLIENT_ID',
  ...
  [ApiProvider.AMADEUS_OFFERS]: {
    provider: ApiProvider.AMADEUS_OFFERS,
    displayName: 'Amadeus Offers',
    description: 'Amadeus Travel Offers API for package deals and bundled travel products',
    documentation: 'Get credentials from: https://developers.amadeus.com → My Self-Service Workspace → Create App',
    sourcePolicy: 'env-only',
    envVars: {
      clientId: 'AMADEUS_CLIENT_ID',
    ...
    costTier: 'medium',
    features: [
      'Travel package offers',
      'Bundled flight and hotel deals',
      'Dynamic pricing',
      'Industry-standard GDS data',
    ],
    requiredFields: [
  ...
  [ApiProvider.AMADEUS_TRANSFERS]: {
    provider: ApiProvider.AMADEUS_TRANSFERS,
    displayName: 'Amadeus Transfers',
    description: 'Amadeus Transfer Search API for airport and point-to-point transfers',
    documentation: 'Get credentials from: https://developers.amadeus.com → My Self-Service Workspace → Create App',
    sourcePolicy: 'env-only',
    envVars: {
      clientId: 'AMADEUS_CLIENT_ID',
