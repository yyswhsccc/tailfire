...
export const credentialSchemaMap = {
  ...
  [ApiProvider.AMADEUS_ACTIVITIES]: amadeusCredentialsSchema,
  [ApiProvider.AMADEUS_HOTELS]: amadeusCredentialsSchema,
  [ApiProvider.AMADEUS_OFFERS]: amadeusCredentialsSchema,
  [ApiProvider.AMADEUS_TRANSFERS]: amadeusCredentialsSchema,
