...
This section is the beginning of the advisor and operations help center for Tailfire.

Use these pages to learn how to use the platform in day-to-day work:
...
- where key tools live in the admin app
- when to use each feature
- practical workflows for advisors and support staff
- distinctions between reusable content, trip records, contact records, and communication tools

## Recommended Reading Order

1. [Libraries](./Agent-Guide-Libraries.md)
2. [Create A Trip](./Agent-Guide-Create-A-Trip.md)
3. [Build And Propose An Itinerary](./Agent-Guide-Build-And-Propose-An-Itinerary.md)
4. [Record Supplier Bookings](./Agent-Guide-Record-Supplier-Bookings.md)
